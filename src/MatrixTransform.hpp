...
namespace Math
{
	...
	template<typename T>
	Vector<3, T, float> GetTranslation(const Matrix<4, 4, T> &mat)
	{
	...
	template<typename T>
	Vector<3, T, float> GetEulerRotation(const Matrix<4, 4, T> &mat)
	{
	...
	template<typename T>
	Quaternion GetQuatRotation(const Matrix<4, 4, T> &mat)
	{
		Vector<3, T, float> mat0 = mat[0].Normalized();
		Vector<3, T, float> mat1 = mat[1].Normalized();
		Vector<3, T, float> mat2 = mat[2].Normalized();
	...
	template<typename T>
	Vector<3, T, float> GetScale(const Matrix<4, 4, T> &mat)
	{
		Vector<3, T, float> res;
		res[0] = mat[0].Length();
		res[1] = mat[1].Length();
	...
	template<typename T>
	void SetTranslation(Matrix<4, 4, T> &mat, const Vector<3, T, float> &pos)
	{
		memcpy(&mat[3], &pos, 3 * sizeof(T));
	}

	template<typename T>
	void SetRotation(Matrix<4, 4, T> &mat, const Vector<3, T, float> &rot)
	{
	...
	template<typename T>
	void SetRotation(Matrix<4, 4, T> &mat, const QuaternionT<T, float> &quat)
	{
		SetRotation(mat, quat.ToEulerAngles());
	}

	template<typename T>
	void SetScale(Matrix<4, 4, T> &mat, const Vector<3, T, float> &scale)
	{
