...
{
	template<typename T>
	Matrix<4, 4, T> Ortho(const T left, const T right, const T bottom, const T top, const T near, const T far)
	{
		Matrix<4, 4, T> res(T(1));
	...
	template<typename T>
	Matrix<4, 4, T> Frustum(const T left, const T right, const T bottom, const T top, const T near, const T far)
	{
	...
	template<typename T>
	Matrix<4, 4, T> Perspective(const T fovY, const T aspect, const T near, const T far)
	{
	...
	template<typename T>
	Matrix<4, 4, T> PerspectiveFov(const T fov, const T width, const T height, const T near, const T far)
	{
		assert(width > T(0));
		assert(height > T(0));
		assert(fov > T(0));
